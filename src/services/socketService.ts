...
export class SocketService {
  ...
  constructor(sessionId: string, _socketUrl: string = 'ws://127.0.0.1:8001/api/v1/chat/stream') {
    this.sessionId = sessionId;
    // Socket URL will be used for connection (parameter prefixed with _ to avoid unused warning)
  }
